...
class CointopayIntlCC_Paymentgateway_CheckoutController extends Mage_Core_Controller_Front_Action
{
	/**
    * @var Context
    */
    ...
    **/
    ...
    public function indexAction()
    {
        ...
        if ($isAjax) {
            ...
            $this->securityKey = trim(Mage::getStoreConfig('payment/cointopayintlccgateway/intl_cc_merchant_gateway_security', $storeScope));
