...
class CointopayIntlCC_Paymentgateway_OrderController extends Mage_Core_Controller_Front_Action
{
    protected $_context;
    ...
    */
    const XML_PATH_MERCHANT_KEY = 'payment/cointopayintlccgateway/intl_cc_merchant_gateway_key';
