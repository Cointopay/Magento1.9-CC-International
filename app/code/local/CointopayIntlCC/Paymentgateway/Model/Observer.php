...
class CointopayIntlCC_Paymentgateway_Model_Observer
{
    protected $_context;
   ...
   */
    ...
    **/
    private function sendCoins ($orderId = 0) {
        ...
        $this->_curlUrl = 'https://cointopay.com/MerchantAPI?Checkout=true&MerchantID='.$this->merchantId.'&Amount='.$this->orderTotal.'&AltCoinID=625&CustomerReferenceNr='.$orderId.'&SecurityCode='.$this->securityKey.'&output=json&inputCurrency='.$this->currencyCode.'&transactionconfirmurl='.Mage::getBaseUrl().'cointopayintlccgateway/order/&transactionfailurl='.Mage::getBaseUrl().'cointopayintlccgateway/order/';
        $fields = array();
